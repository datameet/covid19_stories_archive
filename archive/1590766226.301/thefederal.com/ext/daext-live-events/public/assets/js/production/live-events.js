window.twttr = function(d, s, id) {
    ...
    js.src = "https://thefederal.com/other/js/widgets.js";
...
(function($) {
    ...
    window.DALE.timeline = {
        process: function(tabIndex, timelineData) {
            ...
            "use strict";
            var html = "",
                htmlTimelineItem, htmlTimelineItems = "",
                timelineItemIdA = [],
                el = null,
            ...
            layoutHtml += '<div class="dale-body-timeline-content' + displayNoneClass + '">' + value.content + "</div>";
                ...
                case 1:
                    if (value.image.trim().length > 0) {
                        ...
                        layoutHtml += '<div class="dale-body-timeline-image"><figure><img src="' + value.image + '" style="margin:0"><figcaption class="wp-caption-text imagecaption" style="font-size: 14px !important;">' + window.DALE.utility.escapeHtml(value.imagecaption) + '</figcaption></figure></div>'
                    }
                    break;
                case 2:
...
(function($) {
    ...
    window.DALE.comment = {
        process: function(tabIndex, commentData) {
            "use strict";
            var commentCollection, listOfCommentItemId = [],
