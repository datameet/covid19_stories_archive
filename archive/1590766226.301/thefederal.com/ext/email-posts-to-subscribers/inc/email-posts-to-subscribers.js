(function ($) {
	...
	function EmailPostsSubscribersFun(form){ 
		...
		$.ajax({
			...
			data: formData,
			dataType: 'json',
			success: function (response) { //alert('before'); console.log('submitter success:');  alert(JSON.stringify(response)); console.log(response);
	...
	$(document).ready(function () { 
		$('body').on('submit', '.elp_form', function (e) { 
			e.preventDefault();
			var form = $(this); 
