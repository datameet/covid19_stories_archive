...
width: 451,			// Set to 0 to let the plugin figure it out
height: 782,			// Set to 0 to let the plugin figure it out
overlay_width: 451,		// The overlay element's width. Set to 0 to use the same as 'width'
overlay_height: 782,		// The overlay element's height. Set to 0 to use the same as 'height'
...
overlay_y_position: 'center',	// [center, top, bottom] The position of the overlay vertically (if overlay_width is different from width)
...
fade_speed: 1400, 		// Effect ducation for the 'fade' effect only
...
var imgwidthhds="";
if(gbscreenwidth==1024)
{	imgwidthhds=340;
	
}else if (gbscreenwidth==1366)
{
	imgwidthhds=451;
}
else if (gbscreenwidth==1280)
{
	imgwidthhds=460;
}
else if (gbscreenwidth<=768)
{
	imgwidthhds=480;
}

var $ch_hover = $('<div>').addClass(settings.hover_class).css({ 'width':imgwidthhds, 'height':782, 'position':'absolute', 'z-index':settings.zindex-1 }).appendTo($ch_wrapper);
*/
