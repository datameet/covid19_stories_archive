...
var stylecss = `<style>
                * {
                ...
                .corSticky-heading{ display: flex; align-items: center; font-weight: 700; font-size: 15px; color: #313231; letter-spacing: -1px;}
                .corSticky-total_no{ font-size: 13px; font-weight: 700; color: #C30000;}
                ...
                .tNum{ width: 50px; text-align: right; font-size: 13px; font-weight: 700; color: #717171;letter-spacing: -0.5px;}
                .dataNo{ text-align: right; font-size: 11px; font-weight: 700;}    
                ...
                .dataupRed{background: url("`+cssjsurl+`images/red-tp.svg") left 4px no-repeat; padding-left: 15px; margin-left: 5px; color:#C30000;}
        ...
        success: function (res) {
            if(res.data) {
                ...
                if(todayData.c != null && todayData.c > 0) {
                    ...
                    if(todayData.c_tday != null && todayData.c_tday > 0){
                        active += '<span class="dataNo dataupRed">'+(todayData.c_tday-(todayData.r_tday+todayData.d_tday)).toLocaleString('en-IN')+'</span>';
                    }
