		...
		{	
			...
			switch(type)
			{
				case 'twitter': // Twitter share
					...
					shareFrom   = 'twitter';
					$('span.csbuttons-count', twitter).hide();
					/* if(count)
					{
...
$.getJSON('http://graph.facebook.com/?id=' + $URL, function( fbdata ) {
	...
	$('span.csbuttons-count:eq(1)').text(fb_count).hide(); 
});
}
